...
EXPORT(void) features_integralImageNormalEstimation_pointxyzandnormal_setSearchMethod(IntegralImageNormalEstimation<PointXYZ, Normal>* ptr, search::Search<PointXYZ>::Ptr tree)
{
